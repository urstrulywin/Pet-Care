...
export default function Home() {
  return (
    <main className="bg-[#5DC9A8] min-h-screen flex flex-col md:flex-row items-center justify-center gap-10 p-6 sm:p-8 lg:p-12  ">
      {/* Left Section */}
      <div className="bg-white/40 p-10 rounded-4xl shadow-lg">
        <Logo />
        <h1 className="text-3xl sm:text-4xl lg:text-5xl font-semibold my-6 max-w-150">
          Manage your <span className="font-extrabold">Pet Daycare</span> with
          ease
        </h1>
        <p className="text-base sm:text-lg lg:text-xl font-medium max-w-lg leading-tight">
